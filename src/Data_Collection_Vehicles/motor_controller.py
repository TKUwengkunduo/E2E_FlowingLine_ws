...
class MOTOR_2_WHEEL_MODE(USB_DEVICE):
    ...
    def setSpeed(self, m1_speed, m2_speed):
        # Motor 1
        self.packetHandler.write4ByteTxRx(self.portHandler,self.m1_id, 104, m1_speed)    # Goal Velocity
        ...
        # Motor 2
        self.packetHandler.write4ByteTxRx(self.portHandler,self.m2_id, 104, m2_speed)
